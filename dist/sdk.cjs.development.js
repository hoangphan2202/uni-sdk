...
var FACTORY_ADDRESS = '0x64203f29f4d6a7e199b6f6afbe65f1fa914c7c4e';
var INIT_CODE_HASH = '0x4829a2cb5b5cd2280b139796d23e1bea43f7caddf4203454607c5a9f3d9f95b6';
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'KAI', 'KAI');
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xAF984E23EAA3E7967F3C5E007fbe397D8566D23d', 18, 'WKAI', 'Wrapped KAI'), _WETH);
...
var PAIR_ADDRESS_CACHE = {//   '0xAF984E23EAA3E7967F3C5E007fbe397D8566D23d': {
  //     '0xD675fF2B0ff139E14F86D87b7a6049ca7C66d76e': '0x256b8a99f69dbdbb5ac781e97f11080a336f5507'
  //   },
  // '0xD675fF2B0ff139E14F86D87b7a6049ca7C66d76e':{
  //     '0xAF984E23EAA3E7967F3C5E007fbe397D8566D23d': '0x256b8a99f69dbdbb5ac781e97f11080a336f5507',
  //     '0x2Eddba8b949048861d2272068A94792275A51658': '0x1eBbF8080149FF07381AFd148bA0AF007f78cD3c',
  // },
  // '0x2Eddba8b949048861d2272068A94792275A51658': {
  //     '0xD675fF2B0ff139E14F86D87b7a6049ca7C66d76e': '0x1eBbF8080149FF07381AFd148bA0AF007f78cD3c'
  // }
};
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          methodName = useFeeOnTransfer ? 'swapExactKAIForTokensSupportingFeeOnTransferTokens' : 'swapExactKAIForTokens'; // (uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForKAISupportingFeeOnTransferTokens' : 'swapExactTokensForKAI'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case exports.TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = 'swapKAIForExactTokens'; // (uint amountOut, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = 'swapTokensForExactKAI'; // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
